...
// Fetch normal storage bookings for the logged-in user
$user_id = $_SESSION['user_id'];
$sql = "SELECT * FROM normal_storage_requests WHERE user_id = ? ORDER BY created_at DESC";
...
<html>
<head>
    <title>View Normal Storage Bookings - TruckLogix</title>
    <meta charset="utf-8" />
...
<body class="is-preload">
    <div id="page-wrapper">
        ...
        <section id="main" class="container">
            <header>
                <h2>Your Normal Storage Bookings</h2>
            </header>
            <div class="box">
                ...
                <?php else: ?>
                    <p>You have no normal storage bookings at this time.</p>
                <?php endif; ?>
            </div>
        </section>
