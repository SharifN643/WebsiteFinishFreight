...
<html>
	<head>
		<title>Temperature-Controlled Storage Form - TruckLogix</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		<div id="page-wrapper">
			...
			<section id="main" class="container">
				<header>
					<h2>Temperature-Controlled Storage Request Form</h2>
					<p>Request temperature-controlled storage for your goods</p>
				</header>
				<div class="box">
					<form method="post" action="process_temperature_controlled_storage.php">
						...
						<div class="row gtr-50 gtr-uniform">
							...
							<div class="col-4 col-12-mobilep">
								<input type="number" name="weight" id="weight" value="" placeholder="Weight (kg)" required />
							</div>
							<div class="col-4 col-12-mobilep">
						...
						<h3>Temperature-Controlled Storage Details</h3>
						<div class="row gtr-50 gtr-uniform">
							<div class="col-12">
								<input type="text" name="temperatureRange" id="temperatureRange" value="" placeholder="Required Temperature Range" required />
							</div>
							<div class="col-12">
								<textarea name="specialHandling" id="specialHandling" placeholder="Special Handling Instructions" rows="3"></textarea>
							</div>
						</div>
